...
class GenerateIconList extends Command
{
    ...
    public $libraries = [
        ...
        // 'mallardduck/blade-boxicons' => ['component' => 'bx', 'types' => ['solid' => 's', 'logos' => 'l', 'regular' => ''], 'title' => 'Boxicons', 'url' => 'https://boxicons.com/'],
        ...
        // 'owenvoke/blade-fontawesome' => ['component' => 'fas', 'types' => ['solid' => 's', 'brands' => 'b', 'regular' => ''], 'title' => 'Font Awesome', 'url' => 'https://fontawesome.com/'],
    ...
    public function handle()
    {
        ...
        Storage::disk('local')->put('icons.json', json_encode($data));
    }
}
